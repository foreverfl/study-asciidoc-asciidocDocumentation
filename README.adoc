...
|n/a
| ```
|소스 코드 또는 키보드 입력이 입력한 대로 표시됩니다. 문서에서 소스 하이라이터가 활성화되고 언어가 설정된 경우 색상이 지정됩니다.
|Verbatim
|Listing
[listing]소스 코드 또는 키보드 입력이 입력한 대로 표시됩니다.Verbatim
|Literal
|[literal]
|....
...
|Verbatim
|Open
Most block names패스스루 또는 테이블 블록을 제외한 모든 블록 역할을 할 수 있는 익명 블록Varies
|Passthrough
|[pass]
|++++
...
|Normal
|Source
[source]입력한 대로 표시할 소스 코드 또는 키보드 입력. 문서에서 소스 하이라이터가 활성화되고 언어가 설정된 경우 색상이 지정됩니다.Verbatim
|Stem
|[stem]
|++++
